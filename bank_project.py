...
ClaintsNames = ['Praveen', 'Siva', 'Satheesh', 'Naresh', 'Keerthana']
ClaintsPins = ['1234', '2345', '3456', '4567', '5678']
...
while True:
    # os.system("cls")
    print("=====================================")
    print(" ----Welcome to kangundi bank----       ")
    print("*************************************")
    ...
    if choiceNumber == "1":
        ...
        while j < 1:
            ...
            # ClaintsNames list.
            while k < len(ClaintsNames) - 1:
                k = k + 1
                # These two if conditions find where both the name and pin matches.
                if name == ClaintsNames[k]:
                    if pin == ClaintsPins[k]:
                        j = j + 1
